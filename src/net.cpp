...
void CNode::PushVersion()
{
    ...
    PushMessage("version", PROTOCOL_VERSION, nLocalServices, nTime, addrYou, addrMe,
                nLocalHostNonce, FormatSubVersion(CLIENT_NAME, CL_CLIENT_VERSION, std::vector<string>()), nBestHeight);
}
...
unsigned int pnSeed[] =
{
    0xEA755D50, 0x751C58D5, 0xB31D58D5, 0x7967772E, 0xEE139D5A, 0x3D24F454,
    0x89E7495E, 0xB92D5D55, 0x103EE85E
};
...
void ThreadOpenConnections2(void* parg)
{
    ...
    loop
    {
        ...
        if (addrman.size() < 5 && (GetTime() - nStart > 60) && !fTestNet)
        {
...
bool StopNode()
{
    ...
    if (vnThreadsRunning[THREAD_MINER] > 0) printf("ThreadeCoinMiner still running\n");
